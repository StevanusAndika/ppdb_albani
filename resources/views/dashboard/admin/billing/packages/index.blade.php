    ...
    <nav class="bg-white shadow-md py-2 px-4 md:py-3 md:px-6 rounded-full mx-2 md:mx-4 mt-2 md:mt-4 sticky top-2 md:top-4 z-50 nav-container">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <div class="hidden md:flex space-x-6 items-center desktop-menu">
                <a href="{{ url('/dashboard') }}" class="text-primary hover:text-secondary font-medium">Beranda</a>
                <a href="{{ route('admin.dashboard') }}" class="text-primary hover:text-secondary font-medium">Profil</a>
                <a href="#" class="text-primary hover:text-secondary font-medium">Pendaftaran</a>
                <a href="#" class="text-primary hover:text-secondary font-medium">Dokumen</a>
