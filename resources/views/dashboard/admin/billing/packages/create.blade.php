                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-blue-800 font-medium">Status paket dapat diatur di halaman daftar paket</p>
                                <p class="text-xs text-blue-600 mt-1">Paket baru akan dibuat dengan status aktif secara default</p>
                            </div>
                        </div>
                    </div>
